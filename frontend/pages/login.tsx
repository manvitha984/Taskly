...
export default function LoginPage() {
  ...
  const submit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!data.token) {
        setError(data.message || "Login succeeded but token was not returned");
        return;
      }
      ...
      <div className="mx-auto grid w-full max-w-6xl items-center gap-10 lg:grid-cols-2">
        <section className="hidden lg:block">
          ...
          <p className="mt-4 max-w-md text-slate-600">
            Login to your Taskly workspace and manage projects, tasks, and collaboration from one dashboard.
          </p>
        </section>
        ...
        <section>
          ...
          >
            ...
            <p className="mt-1 text-sm text-slate-600">Sign in to your Taskly account.</p>
